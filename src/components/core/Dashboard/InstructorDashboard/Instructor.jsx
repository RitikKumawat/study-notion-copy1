...
export const Instructor = () => {
    ...
    <div>
                            ...
                            <div key={course._id} className='w-1/3'>
                                ...
                                <div className="mt-3 w-full">
                                    ...
                                    <div className="mt-1 flex items-center space-x-2">
                                        <p className="text-xs font-medium text-richblack-300">{course.studentsEnrolled.length} Student(s)</p>
        ...
        </div>):(<div className="mt-20 rounded-md bg-richblack-800 p-6 py-20">
