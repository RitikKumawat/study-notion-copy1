...
export const Navbar = () => {
   ...
   useEffect(()=>{
    ...
    <div className='flex h-14 items-center justify-center  bg-richblack-800 border-b-richblack-700 border-b-[1px]'>
        <div className='w-11/12 max-w-maxContent flex flex-row justify-between items-center    '>
            ...
            <nav>
                ...
                <ul className='flex gap-x-6 text-richblack-25 text-base px-3 py-1 justify-center'>
                    {
